...
const Projects = () => {
    return (
        ...
        <div className="px-5 md:px-8 lg:px-20 my-16">
           ...
           <div className="mb-8">
            <h2 className="text-3xl font-bold ubuntu mb-3 ">Step Style</h2>
            <p className=" text-gray-500 flex items-start gap-2 mb-3">This project is a shoes ordering platform where users can order and make payments online. Admins can manage the product by adding, updating, and deleting items. and more features I have added</p>
